...
graph TD
    ...
    subgraph "Forensic Aggregation"
        Caddy -->|Audit Event Identifier 540001| Loki[(Loki)]
        Auth -->|Audit Event Identifier 400004| Loki
        Anubis -->|Audit Event Identifier 460000| Loki
    end
...
4.  **Forensic Trail**: Every transition between networks is logged via Audit Event Identifiers to Loki.
