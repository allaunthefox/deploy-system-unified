...
| :--- | :--- | :--- | :--- | :--- |
| T1 | SOPS Migration Execution | Complete (Phase 6: SOPS-only) | Preflight supports vault/sops/dual; secrets_config.yml = "sops" | `inventory/group_vars/all/secrets.sops.yml` + `playbooks/preflight_assertions.yml` |
