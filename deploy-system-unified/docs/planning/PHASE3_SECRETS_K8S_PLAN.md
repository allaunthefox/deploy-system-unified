...
| T3 | Helm Chart Standardization | In Progress | Base Helm charts for core services (Media/Ops) adapting existing Quadlet logic | `charts/media-stack/` + `charts/ops-stack/` |
