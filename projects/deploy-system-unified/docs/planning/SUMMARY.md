...
3. ✅ Implement `roles/ops/health_check` and wire post-deploy health summary into production flow (production-context validation pending; local evidence: `ci-artifacts/health/20260212T211810Z/`).
