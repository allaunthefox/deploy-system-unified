...
**Generated:** 2026-02-24T03:08:01.428793  
**Roles Path:** roles
...
| Metric | Value |
|--------|-------|
| Total Roles Scanned | 68 |
| Total Tasks | 562 |
| Tagged Tasks | 1575 |
| **Overall Coverage** | **280.2%** |
| CIS Controls Mapped | 318 |
| STIG Controls Mapped | 205 |
| NIST Controls Mapped | 47 |
...
| NIST AC-2 | NIST AC | security/access | 2 |
...
| NIST AC-4 | NIST AC | networking/container_networks, networking/firewall, networking/virtual, security/kernel | 8 |
| NIST AC-5 | NIST AC | security/access | 2 |
| NIST AC-6 | NIST AC | containers/caddy, containers/lxc, containers/quadlets, containers/runtime, hardware/gpu, hardware/virtual_guest, ops/preflight, security/access, security/firejail, security/resource_protection, virtualization/kvm | 20 |
| NIST AC-7 | NIST AC | security/sshd | 1 |
...
| NIST AU-4 | NIST AU | security/audit_integrity | 1 |
...
| NIST CM-6 | NIST CM | containers/caddy, containers/config, containers/media, containers/monitoring, containers/quadlets, containers/runtime, core/systemd, hardware/firmware, hardware/gpu, hardware/sas, kubernetes/master, kubernetes/node, networking/desktop, networking/physical, ops/cloud_init, ops/guest_management, ops/preflight, orchestration/k8s_node | 44 |
...
| NIST IA-5 | NIST IA | core/secrets, security/access, security/advanced | 11 |
...
| NIST SC-13 | NIST SC | containers/caddy, networking/vpn_mesh, security/sshd | 5 |
...
| NIST SC-4 | NIST SC | core/memory, security/kernel | 8 |
...
| NIST SC-7 | NIST SC | kubernetes/master, kubernetes/node, networking/container_networks, networking/desktop, networking/firewall, networking/physical, networking/virtual, networking/vpn_mesh, ops/connection_info, ops/pre_connection, ops/preflight, orchestration/k8s_node, security/kernel | 51 |
...
| NIST SI-16 | NIST SI | security/kernel | 1 |
...
| security/kernel | 3 | 12 | 400.0% | 2 | 0 | 7 | 1 |
...
- **CIS Benchmarks**: 318 controls mapped across 68 roles
- **DISA STIG**: 205 controls mapped
- **NIST SP 800-53**: 47 controls mapped across multiple control families
