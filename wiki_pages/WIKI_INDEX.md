...
|----------|---------|----------|
| [README.md](Home) | Project overview | All users |
| [docs/INDEX.md](Documentation_Index) | Documentation hub | All users |
| [docs/deployment/DEPLOYMENT_QUICK_REFERENCE.md](DEPLOYMENT_QUICK_REFERENCE) | One-page quick ref | Operators |
| [docs/deployment/PRODUCTION_RUNBOOK.md](PRODUCTION_RUNBOOK) | Step-by-step deploy | Operators |
...
| Document | Purpose | Audience |
|----------|---------|----------|
| [docs/architecture/README.md](Home) | Core philosophy | Architects |
| [docs/architecture/VIRTUAL_NETWORKING.md](VIRTUAL_NETWORKING) | VLAN/VXLAN design | Network engineers |
| [docs/architecture/SECURITY_LAYERS.md](SECURITY_LAYERS) | 5-layer defense | Security team |
| [docs/architecture/MODULAR_LAYERS.md](MODULAR_LAYERS) | Layered architecture | Architects |
...
|----------|---------|----------------|
| [docs/deployment/DEPLOYMENT_MATRIX.md](DEPLOYMENT_MATRIX) | All valid combinations | All 11 stacks |
| [docs/deployment/DEPLOYMENT_INCOMPATIBILITIES.md](DEPLOYMENT_INCOMPATIBILITIES) | Invalid combinations | All 11 stacks |
| [docs/deployment/ANUBIS_DEPLOYMENT.md](ANUBIS_DEPLOYMENT) | Anubis AI Firewall | Anubis only |
| [docs/deployment/PRODUCTION_RUNBOOK.md](PRODUCTION_RUNBOOK) | Production deployment | All stacks |
...
|----------|---------|-----------|
| [docs/security/SECURITY_STANDARDS.md](SECURITY_STANDARDS) | Security requirements | CIS, NIST, ISO 27001 |
| [DSU_AUDIT_EVENT_IDENTIFIERS.md](DSU_AUDIT_EVENT_IDENTIFIERS) | Audit code catalog | ISO 27001, ISO 27040 |
| [docs/security/THREAT_MODEL.md](THREAT_MODEL) | STRIDE analysis | ISO 27001 |
| [docs/compliance/COMPLIANCE_REPORT.md](COMPLIANCE_REPORT) | Compliance status | CIS, NIST, ISO |
...
|-------|------|---------------|-----------------|
| **anubis** | Container (Podman) | [docs/deployment/ANUBIS_DEPLOYMENT.md](ANUBIS_DEPLOYMENT) | ✅ |
...
|----------|---------|-------|
| [docs/development/CONTRIBUTING.md](CONTRIBUTING) | Contributing guide | Git, Ansible |
| [docs/development/STYLE_GUIDE.md](STYLE_GUIDE) | Code style | yamllint, ansible-lint |
| [docs/development/MOLECULE_TESTING.md](MOLECULE_TESTING) | Molecule tests | Molecule, Docker |
| [scripts/validate-chart-security.sh](validate-chart-security.sh) | Chart validation | Bash, grep |
| [scripts/validate-deployment-compatibility.sh](validate-deployment-compatibility.sh) | Compatibility check | Bash, kubectl |
...
|----------|---------|-----------|
| [docs/RESTORE_RUNBOOK.md](RESTORE_RUNBOOK) | Disaster recovery | As needed |
| [docs/deployment/PRODUCTION_RUNBOOK.md](PRODUCTION_RUNBOOK) | Daily operations | Daily |
| [docs/benchmarks/]() | Performance baselines | Monthly |
| [docs/planning/ROADMAP.md](ROADMAP) | Future planning | Quarterly |
...
|----------|---------|----------|
| [charts/README.md](Home) | Chart deployment guide | charts/ |
| [charts/_templates/_security-helpers.tpl](_security-helpers.tpl) | Security templates | charts/ |
| [charts/*/values.production.yaml]() | Production values | charts/*/ |
...
- [DSU_AUDIT_EVENT_IDENTIFIERS.md](DSU_AUDIT_EVENT_IDENTIFIERS)
