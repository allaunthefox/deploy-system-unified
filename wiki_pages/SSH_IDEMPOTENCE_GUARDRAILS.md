...
These measures were introduced following the [SSH Incident Postmortem](SSH_INCIDENT_POSTMORTEM) to prevent configuration drift, duplicate directives, and service failures.
