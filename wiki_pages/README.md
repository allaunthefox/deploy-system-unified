...
* **[Base Hardened](BASE_HARDENED)**: Standard secure foundation (Firewall, SSH Hardening, Time Sync).
* **[Base Ephemeral](BASE_EPHEMERAL)**: Volatile foundation (RAM-disks, secure shredding, immutable audit trails).
